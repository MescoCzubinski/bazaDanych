...
let lubin_zolty_col_names = ["Odmiana:", "Rok wyników:", "Plon ziarna:", "Plon białka ogól.:", "Zawartość białka ogólnego:", "Masa 1000 nasion:", "Wysokość roślin:", "Wyleganie:", "Typ:", "Rok wpisu do KR:", "Barwa kwiatów:", "Okres od siewu do dojrzałości technicznej:", "Zawartość tłuszczu surowego:", "Zawartość włókna surowego:", "Długość fazy kwitnienia:", "Zawartość alkaloidów:", "Udział roślin zielonych przed zbiorem:", "Odporność na wyleganie po zakończeniu kwitnienia:", "Pękanie strąków:", "Antraknoza – 2. termin:", "Antraknoza – 1. termin:", "Choroby fuzaryjne:", "Równomierność dojrzewania:", "Dolnośląskie:", "Kujawsko-Pomorskie:", "Lubelskie:", "Lubuskie:", "Łódzkie:", "Małopolskie:", "Mazowieckie:", "Opolskie:", "Podkarpackie:", "Podlaskie:", "Pomorskie:", "Śląskie:", "Świętokrzyskie:", "Warmińsko-Mazurskie:", "Wielkopolskie:", "Zachodniopomorskie:", "Porównaj"];
...
let lubin_zolty_units = ["", "r.", "dt/ha", "kg/ha", "%", "g", "cm", "skala", "", "r.", "", "dni", "%", "%", "dni", "%", "skala", "skala", "skala", "skala", "skala", "skala", "skala", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", "r.", ""];
let lubin_zolty_year = ["2025"];

let lubin_waskolistny_col_names = ["Odmiana:", "Rok wyników:", "Plon nasion:", "Plon białka ogól.:", "Zawartość białka ogólnego:", "Masa 1000 nasion:", "Wysokość roślin:", "Wyleganie:", "Typ:", "Rok wpisu do KR:", "Barwa kwiatów:", "Zawartość tłuszczu surowego:", "Zawartość włókna surowego:", "Zawartość alkaloidów:", "Okres od siewu do dojrzałości technicznej:", "Równomierność dojrzewania:", "Pękanie strąków:", "Odporność na antraknozę termin I:", "Fuzaryjne więdnięcie:", "dolnośląskie:", "kujawsko-pomorskie:", "lubelskie:", "lubuskie:", "łódzkie:", "małopolskie:", "mazowieckie:", "opolskie:", "podkarpackie:", "podlaskie:", "pomorskie:", "śląskie:", "świętokrzyskie:", "warmińsko-mazurskie:", "wielkopolskie:", "zachodniopomorskie:", "Porównaj"];
...
let lubin_waskolistny_units = ["", " r.", " dt/ha", " kg/ha", "%", "g", "cm", " dt/ha", "", " r.", "", "%", "%", "%", " dni", " dt/ha", "", " dt/ha", " dt/ha", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", ""];
let lubin_waskolistny_year = ["2025", "2023", "2021"];
...
let lubin_bialy_col_names = ["Odmiana:", "Rok wyników:", "Plon nasion:", "Plon białka ogól.:", "Zawartość białka ogólnego:", "Masa 1000 nasion:", "Wysokość roślin:", "Wyleganie przed zbiorem:", "Typ:", "Rok wpisu do KR:", "Barwa kwiatów:", "Zawartość tłuszczu surowego:", "Zawartość włókna surowego:", "Zawartość alkaloidów:", "Okres od siewu do dojrzałości technicznej:", "Okres od siewu do początku kwitnienia:", "Długość fazy kwitnienia:", "Równomierność dojrzewania:", "Udział roślin zielonych przed zbiorem:", "Pękanie strąków:", "Antraknoza:", "Dolnośląskie:", "Kujawsko-Pomorskie:", "Lubelskie:", "Lubuskie:", "Łódzkie:", "Małopolskie:", "Mazowieckie:", "Opolskie:", "Podkarpackie:", "Podlaskie:", "Pomorskie:", "Śląskie:", "Świętokrzyskie:", "Warmińsko-Mazurskie:", "Wielkopolskie:", "Zachodniopomorskie:", "Porównaj"];
...
let lubin_bialy_units = ["", " r.", " dt/ha", " kg/ha", "%", " g", " cm", " dt/ha", "", " r.", "", "%", "%", "%", " dni", " dni", " dni", " dt/ha", "%", " dt/ha", " dt/ha", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", " r.", ""];
